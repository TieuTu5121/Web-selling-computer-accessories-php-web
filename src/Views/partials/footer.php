<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
        ...
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="" class="text-decoration-none">
                <h1 class="mb-4 display-5 font-weight-semi-bold"><span
                        class="text-primary font-weight-bold border border-white px-3 mr-1">NT</span>Shopper</h1>
            </a>

            <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Can Tho</p>
            <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>ntduong2805@gmail.com</p>
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
        ...
        <div class="col-md-6 px-xl-0 text-center text-md-right">
            <img class="img-fluid" src="<?= BASEURL; ?>img/payments.png" alt="">
        </div>
    </div>
</div>
