            ...
            <div class="col-lg-8">
                <div class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                            <input class="form-control" name="customer_email" value=""
                                type="text" placeholder="example@email.com">
                            
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Số điện thoại</label>
                            <input class="form-control" name="customer_phone" value=""
                                type="text" placeholder="+123 456 789">
                            
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Địa chỉ</label>
                            <input class="form-control" name="customer_address" value=""
                                type="text" placeholder="123 Street">
                            
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Note</label>
                            <textarea class="form-control" value="" name="note" type="text"
                ...
                <div class="total_area card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <h5 class="font-weight-bold total-price-all">0 VNĐ</h5>
