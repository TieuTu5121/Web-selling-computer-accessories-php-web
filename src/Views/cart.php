        ...
        <table class="table table-bordered text-center mb-0">
            ...
            <tbody class="align-middle">
                ...
                <tr id="row-{{ $item->id }}">
                    ...
                    <td class="align-middle">
                        <span id="cartProductPrice{{ $item->id }}">${{ $item->product->sale ? $item->product->sale_price
                            * $item->product_quantity : $item->product->price * $item->product_quantity }}</span>
    ...
    <div class="col-lg-4">
        ...
        <div class="card-footer border-secondary bg-transparent">
            ...
            <a href="
                      ...
                      " class="btn btn-block btn-primary my-3 py-3">Proceed
                To Checkout</a>
        </div>
    </div>
</div>
